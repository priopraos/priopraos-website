            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                ...
                },
                {
                  ...
                  uk: 'In the United Kingdom: NHS England GP Workforce Statistics (NHS Digital) at sub-ICB level, updated monthly.',
                },
                {
          ...
          <ScrollReveal delay={230}>
            ...
            <div className="relative pl-6 border-l-4 border-[#005EB8] bg-white rounded-r-xl py-4 pr-4 shadow-sm mb-12">
              <p className="text-lg text-gray-700 leading-relaxed">
                In addition to the composite score, the EFE™ applies a specialty-level health inequality flag. Every posting is cross-referenced against national condition prevalence data for the local authority it serves. Where the posted clinical specialty aligns with a condition disproportionately prevalent in that community relative to the national average, a Specialty Need Flag is attached to the posting record. This flag adds a fifth layer of independently verified, specialty-specific evidence to the compliance record generated by the ECE™.
              </p>
              <p className="text-sm text-gray-600 leading-relaxed mt-3 italic">
                In the United Kingdom: OHID Fingertips Local Authority Health Profiles, aligned with the NHS England Core20PLUS5 national health inequalities programme.
              </p>
            </div>
          </ScrollReveal>
