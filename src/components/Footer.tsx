      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
                            <li><a href="https://locumstation.co.uk/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors">Visit Locum Station</a></li>
              <li><a href="https://locumstation.co.uk/early-access/providers" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors">Register as a Provider</a></li>
              <li><a href="https://locumstation.co.uk/early-access/clinicians" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors">Join as a Clinician</a></li>
              <li><a href="https://locumstation.co.uk/our-innovations" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition-colors">Our Innovations</a></li>
            </ul>
          </div>
